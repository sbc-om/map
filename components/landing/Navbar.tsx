...
export function Navbar() {
  return (
    <nav className="relative z-50 w-full px-6 py-5" role="navigation">
      <div className="mx-auto flex max-w-7xl items-center justify-between">
        ...
        <a
          ...
          className="flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-4 py-2 text-sm font-medium text-white/60 backdrop-blur-sm transition-all duration-200 hover:bg-white/10 hover:border-white/25 hover:text-white"
